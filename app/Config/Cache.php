...
class Cache extends BaseConfig
{
    public function __construct()
    {
        ...
        // Read dynamic configuration from admin settings (admin/settings/session)
        ...
        if (file_exists($configFile)) {
            ...
            if ($config && isset($config['driver'])) {
                if ($config['driver'] === 'redis') {
                    ...
                    // Apply Redis connection details from admin config
                    $this->redis = [
                    ...
                    // For file or database session, use file handler for cache
                    $this->handler = 'file';
                }

                // Apply custom TTL if set

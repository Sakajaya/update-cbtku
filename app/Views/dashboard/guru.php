...
<style>
    /* ===== GURU DASHBOARD — Selaras dengan Admin Dashboard ===== */
    .page-header {
...
<div class="container-fluid px-4">
    ...
    <div class="page-header mt-4">
        ...
        <p>Selamat datang, <strong><?= esc($user['name'] ?? 'Guru') ?></strong>! Kelola ujian dan pantau aktivitas siswa
            Anda.</p>
    </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-card-label">Bank Soal Saya</div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-card-label">Total Ujian Saya</div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-card-value"><?= number_format($globalStudents ?? 0) ?></div>
                <div class="stat-card-label">Total Siswa (Sekolah)</div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-card-value"><?= number_format($globalActiveUsers ?? 0) ?></div>
                <div class="stat-card-label">Siswa Sedang Ujian</div>
            </div>
        </div>
    </div>

    <!-- License Info (sama seperti admin) -->
    <?php if ($license): ?>
        <div class="row g-3 mb-4">
            <div class="col-12">
                    ...
                    <div class="modern-card-body">
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="fw-bold"><?= esc(substr($license['license_key'] ?? '', 0, 20)) ?>...
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-4 text-end">
                                <?php if ($license['expires_at'] ?? null): ?>
                                    <?php
        ...
        <div class="col-12">
            <div class="modern-card">
                ...
                <div class="modern-card-body">
                    <div class="row g-2">
                        <div class="col-6 col-md-3">
                            <a href="<?= base_url('admin/cbt/banksoal/create') ?>" class="action-card"
                        ...
                        <div class="col-6 col-md-3">
                            <a href="<?= base_url('admin/cbt/teststatus/create') ?>" class="action-card"
                        ...
                        <div class="col-6 col-md-3">
                            <a href="<?= base_url('admin/cbt/aktivitas') ?>" class="action-card"
                        ...
                        <div class="col-6 col-md-3">
                            <a href="<?= base_url('admin/cbt/banksoal') ?>" class="action-card"
    ...
    <div class="row g-3">
        ...
        <div class="col-md-8">
            <div class="modern-card">
                <div class="modern-card-header">
                    <h3 class="modern-card-title">
                        <i class="fas fa-chart-line"></i> Siswa Sedang Ujian
                        <?php if (!empty($recentActivity)): ?>
                            <span class="badge badge-modern badge-success-gradient ms-2">
                                <?= count($recentActivity) ?> Aktif
                            </span>
                        <?php endif; ?>
                    </h3>
                </div>
                <div class="modern-card-body" style="padding: 0;">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <small class="text-muted">
                                                    ...
                                                    Mulai:
                                                    <?= date('H:i', is_numeric($activity['started_at']) ? $activity['started_at'] : strtotime($activity['started_at'])) ?>
                                                </small>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted"><?= $activity['progress_percent'] ?>% selesai</small>
                                            </td>
                                            <td>
                    ...
                    <?php else: ?>
                        <div class="empty-state py-4">
                            ...
                            <p class="empty-state-text">Belum ada siswa yang sedang mengerjakan ujian Anda saat ini.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="col-md-4">
                ...
                <div class="modern-card-body">
                    <?php if (!empty($upcomingExams)): ?>
                        ...
                        <div class="text-center mt-3">
                            <a href="<?= base_url('admin/cbt/teststatus') ?>"
                                class="btn btn-sm btn-modern btn-primary-gradient">
                                <i class="fas fa-eye"></i> Lihat Semua
                            </a>
                        </div>
                    <?php else: ?>
                        <div class="empty-state py-3">
                            <div class="empty-state-icon" style="font-size: 2rem;"><i class="fas fa-calendar-times"></i>
                            </div>
                            <p class="empty-state-text mb-2">Belum ada ujian yang dijadwalkan.</p>
                            <a href="<?= base_url('admin/cbt/teststatus/create') ?>"
                                class="btn btn-sm btn-modern btn-primary-gradient">
            ...
            <div class="modern-card">
                <div class="modern-card-header">
                    <h3 class="modern-card-title">
                        <i class="fas fa-id-card"></i> Informasi Guru
                    </h3>
                </div>
                <div class="modern-card-body">
                    <?php if ($teacher): ?>
                        <div class="mb-3">
                            ...
                            <div class="fw-bold"><?= esc($teacher['nip'] ?? '-') ?></div>
                        </div>
                    <?php endif; ?>
                    <div class="mb-3">
                        <small class="text-muted">Sekolah</small>
                        <div class="fw-bold"><?= esc($school['name'] ?? '-') ?></div>
                    </div>
                    <div class="mb-3">
                        <small class="text-muted">Role</small>
                        <div>
                            <span class="badge badge-modern badge-primary-gradient">
                                <i class="fas fa-chalkboard-teacher"></i> <?= esc($role) ?>
                            </span>
                        </div>
                    </div>
                    <?php if (!empty($school['name'])): ?>
                        <div>
                            ...
                            <div class="fw-bold"><?= esc($school['headmaster'] ?? '-') ?></div>
                        </div>
                    <?php endif; ?>
                </div>
            </div>

            <!-- System Info Card (sama seperti admin) -->
            <div class="modern-card">
                <div class="modern-card-header">
                    <h3 class="modern-card-title">
    ...
    <!-- School Info (sama seperti admin) -->
    <?php if ($school): ?>
                    ...
                    <div class="modern-card-body">
                        <div class="row align-items-center">
                            <div class="col-md-2 text-center">
                                ...
                                <?php else: ?>
                                    <i class="fas fa-school" style="font-size: 3rem; color: #dee2e6;"></i>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-10">
...
<script>
    // Auto refresh aktivitas setiap 30 detik (selaras dengan admin dashboard)
    setTimeout(function () {
        location.reload();
    }, 30000);
</script>

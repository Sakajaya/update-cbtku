...
<div class="container-fluid px-4 py-4">
  ...
  <!-- Form Card -->
  <div class="form-card">
    <form method="post" action="<?= base_url('admin/subjects/store') ?>" id="subjectForm">
      <?= csrf_field() ?>
      ...
      <div class="info-box">
        ...
        <p class="info-box-text">
          Mata pelajaran digunakan untuk mengelompokkan bank soal dan jadwal ujian. 
          Kode mata pelajaran sebaiknya singkat dan mudah dikenali (contoh: MTK, IPA, IPS).
        </p>
      </div>
      ...
      <div class="form-section">
        ...
        <div class="mb-3" id="religionField" style="display: none;">

...
<div class="container-fluid px-4 py-4">
  ...
  <!-- Form Card -->
  <div class="form-card">
    <form action="<?= base_url('admin/academic-year/store') ?>" method="post" id="academicYearForm">
      <?= csrf_field() ?>
      ...
      <div class="info-box">
        ...
        <p class="info-box-text">
          Tahun ajaran digunakan untuk mengelompokkan data siswa, kelas, dan ujian berdasarkan periode akademik. 

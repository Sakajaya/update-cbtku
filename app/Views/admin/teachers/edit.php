...
<div class="container-fluid px-4 py-4">
  ...
  <!-- Form Card -->
  <div class="form-card">
    <form action="<?= base_url('admin/teachers/update/'.$teacher['id']) ?>" method="post" id="teacherForm">
      <?= csrf_field() ?>
      ...
      <div class="info-box">
        ...
        <p class="info-box-text">
          Perubahan data guru akan mempengaruhi akses login dan informasi yang ditampilkan di sistem.

...
<div class="container-fluid px-4 py-4">
  ...
  <!-- Form Card -->
  <div class="form-card">
    <form action="<?= base_url('admin/classes/store') ?>" method="post" id="classForm">
      <?= csrf_field() ?>
      ...
      <div class="info-box">
        ...
        <p class="info-box-text">
          Kelas digunakan untuk mengelompokkan siswa berdasarkan tingkat dan rombongan belajar. 
          Tingkat menunjukkan jenjang kelas (1-9 untuk SD/SMP, 10-12 untuk SMA/SMK).
        </p>
      </div>

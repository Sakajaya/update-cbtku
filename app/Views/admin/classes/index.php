...
<style>
/* Inline styles untuk Classes page */
.page-header {
...
<div class="container-fluid px-4">
    ...
    <div class="page-header mt-4">
        ...
        <p>Kelola data kelas untuk sistem CBT</p>
        <div class="page-header-actions">
            <a href="<?= base_url('admin/classes/create') ?>" class="btn btn-modern btn-primary-gradient">
        ...
        <div class="modern-card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    <span class="text-muted">
                        Total: <strong><?= count($classes) ?></strong> kelas
                    </span>
                </div>
            </div>
            ...
            <?php if (!empty($classes)): ?>
                <div class="table-responsive">
                    <table class="table table-modern" id="classesTable">
                        <thead>
                            <tr>
                                <th width="60">#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url('admin/classes/edit/'.$c['id']) ?>" 
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p class="empty-state-text">
                        Mulai tambahkan kelas untuk mengelompokkan siswa.
                    </p>
                    <a href="<?= base_url('admin/classes/create') ?>" class="btn btn-modern btn-primary-gradient">
